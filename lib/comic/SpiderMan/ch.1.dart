...
class Ch1Spidermaan extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: SpiderMan(),
      appBar: AppBar(
        title:  Text("Spider-Man: Far From Home Prelude #1", style: TextStyle(fontWeight:  FontWeight.w500 ,fontSize: 17)),backgroundColor: Colors.purple,
        actions: <Widget>[
            // action button
            IconButton(
